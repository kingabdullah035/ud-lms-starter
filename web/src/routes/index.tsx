...
function Home() {
  return (
    <main className="p-6">
      <h1 className="text-2xl font-semibold">UD LMS Starter</h1>
      <p className="mt-2">Frontend → Render API → Supabase</p>
      <ul className="mt-4 list-disc pl-6">
        <li><Link to="/courses">Courses (DB)</Link></li>
        <li><Link to="/assignments">Assignments (DB)</Link></li>
      </ul>
    </main>
  )
}
